<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveUnpaidLeave.aspx.cs" Inherits="Team75.ApproveUnpaidLeave" %>
...
<body>
    <form id="form1" runat="server">
        <div class="wrapper">
            ...
            <!-- Unpaid leave requests table (only visible if authorized) -->
            <asp:Panel ID="pnlUnpaid" runat="server" Visible="false">
                <div class="section-title">Unpaid Leave Requests</div>
                <div class="grid-container">
                    <asp:GridView ID="gvUnpaid" runat="server"
                                  ...
                                  OnRowDataBound="gvUnpaid_RowDataBound">
                        <Columns>
