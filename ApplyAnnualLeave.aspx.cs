...
namespace Team75
{
    public partial class ApplyAnnualLeave : Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Submit_annual", conn))
                {
                    ...
                    // Replacement employee is chosen by HR / system logic,
                    // so we pass NULL from the frontend.
                    cmd.Parameters.AddWithValue("@replacement_emp", DBNull.Value);
                ...
                // On success, go to the page that shows pending annual leave submissions
                Response.Redirect("AnnualLeaveSubmission.aspx");
            }
            catch (Exception ex)
            {
                lblMessage.Text = "Error submitting annual leave: " + ex.Message;
            }
        }
